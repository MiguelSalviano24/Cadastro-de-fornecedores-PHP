...
<div class="container">
    ...
    <form id="create-form" action="/config/actions.php" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="name" name="name" placeholder="Digite o telefone para contato" required>
        </div>
        <div class="mb-3">
            <label for="activity">Área de atuação:</label>
            <input type="text" class="form-control" id="name" name="name" placeholder="Digite a área de atuação" required>
        </div>
